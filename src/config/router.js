const routers = [
    ...
    {path: '/score_import_class',component: (resolve) => require(['../views/score_import_class/index.vue'], resolve)},
    {path: '/score_import_class/view',component: (resolve) => require(['../views/score_import_class/model.vue'], resolve)},
    {path: '/score_import_class/import',component: (resolve) => require(['../views/score_import_class/import.vue'], resolve)},
    {path: '/score_import_class_move',component: (resolve) => require(['../views/score_import_class_move/index.vue'], resolve)},
    {path: '/score_import_class_move/view',component: (resolve) => require(['../views/score_import_class_move/model.vue'], resolve)},
    {path: '/score_import_class_move/import',component: (resolve) => require(['../views/score_import_class_move/import.vue'], resolve)},
