<template>
    <div class="layout-main">
        <div class="layout-content">
           ...
           <bt_school_filter ref="bt_school_filter" import_url="/score_import_class/import" update_url="/score_import_class/view" @selection="selection"></bt_school_filter>
        </div>
        <Row>
             <i-col>
...
<script type="text/javascript">
    ...
    export default {
        ...
        created(){
            ...
            window.config.active_name = '行政班成绩上传管理';
        },
        methods :{
            ...
            go_import : function(){
                __.go(this,'/score_import_class/import');
            },
            go_update : function(){
                ...
                __.go(this,'score_import_class/view',{id : info.ids });
            },
            ...
            set_page : function(index){
                ...
                __.bind_list_dblclick(this,'score_import_class/view');
            },
